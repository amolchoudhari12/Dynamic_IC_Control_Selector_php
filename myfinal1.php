        ...
        <div id="wrapper">
            ...
            <div id="content" align="center">
				...
				<div id="users-contain" class="ui-widget" style="Display:none">
                    			...
                    			<table width="900px" border="1" bgcolor="ffffff"  style="border-color: #666464;">
                    			<tr>
				...
				$DigitBoxTemplate = " <div style='position:absolute; margin-left: [#MARIGN_LEFT#]px; z-index:[#Z_INDEX#]'>			    
			          <div style=' width:20px;'>&nbsp;</div>		
			          <div>
			            <table cellpadding='0' cellspacing='0' border='0'>
			              <tr>
			                <td class='[#BOX_CSS#] nodeText' align='[#TD_ALIGN#]'>[#DIGIT_NO#]</td>
			              </tr>
			              <tr>
			                <td align='[#TD_ALIGN#]'>[#DIGIT_BOX#]</td>
			              </tr>
			              <tr>
			                <td>
			                <table cellpadding='0' cellspacing='0' border='0'>
								...
								for ($i = $initializer; $i < $parametersCount; $i++) 
								{
									...
									if($count <= $leftOptionsCount)
									{
										...
										$lastTDHeight += (15*$rowCount) +30;	 
									 	...
									 	$bodyOfItem = str_replace("[#DIGIT_NO#]", $count, $DigitBoxTemplate);
									    ...
									    $bodyOfItem = str_replace("[#BOX_CSS#]","box_number", $bodyOfItem);
									    $bodyOfItem = str_replace("[#TD_ALIGN#]","right", $bodyOfItem);
									  	...
									  	$bodyOfItem = str_replace("[#Z_INDEX#]",$zIndex, $bodyOfItem);
									  	$zIndex -=1;
									...
									else 
									{
									    ...
									    $bodyOfItem = str_replace("[#MARIGN_LEFT#]", $widthTD, $bodyOfItem);
									  	$bodyOfItem = str_replace("[#BOX_CSS#]","box_number_right", $bodyOfItem);
									    $bodyOfItem = str_replace("[#TD_ALIGN#]","left", $bodyOfItem);
									
										if($parameters[$i] =="COMBINE")		
										{														
											$bodyOfItemTR = str_replace("[#COMBINE_DIV#]", "<div class='u_left'></div>", $bodyOfItemTR);
											
											
											$widthTD +=30;
											
											$digitBoxNext = "<input type='text' value='' style='color:#000000;width:20px' maxlength='4'  style='width:20px; padding: 2px' id='dgtBox".($count+1)."'  name='dgtBox".($count+1)."' />";	 
								
											$bodyOfItemNext = str_replace("[#DIGIT_NO#]",($count +1) , $DigitBoxTemplate);
											$bodyOfItemNext= str_replace("[#DIGIT_BOX#]", $digitBoxNext, $bodyOfItemNext);
																					
										    $bodyOfItemNext = str_replace("[#MARIGN_LEFT#]", $widthTD, $bodyOfItemNext);
										  	$bodyOfItemNext = str_replace("[#BOX_CSS#]","box_number_right", $bodyOfItemNext);
										    $bodyOfItemNext = str_replace("[#TD_ALIGN#]","left", $bodyOfItemNext);
										    $NextTR = "<tr><td class='u_right' ></td></tr>";
										    $bodyOfItemNext = str_replace("[#ROW_OPTION_HEADER#]",$NextTR, $bodyOfItemNext);
									  		$bodyOfItemNext = str_replace("[#ROW_OPTION_VALUES#]","", $bodyOfItemNext);
											$count +=1;
										}
										else
										    $bodyOfItemTR = str_replace("[#COMBINE_DIV#]", "", $bodyOfItemTR);								
										...
										if($bodyOfItemNext != "")
											array_push($rightControlsArray,$bodyOfItemNext);
						...
						?>
                    			 ...
                    			 <tr>
                                   <td align='center' valign='bottom'  >
								       ...
								       <table border="0"  width="835"  style="border-color: #666464;">										
                                                    ...
                                                    <td>
                                             <?php
                                              print "<span style='color:#000000'>".$otekModel->notes."</span>"; 
                                             ?>
