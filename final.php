    ...
    <div align="center">
        <div id="wrapper">
          ...
          <div style='float:right'>
            <table cellpadding='0' cellspacing='0' border='0'>
              <tr>
                <td class='box_number_right nodeText'>[#DIGIT_NO#]</td>
              </tr>
              <tr>
              ...
              <tr>
				...
				?>	
								    ...
								    //Item Collection Iteration
											...
											{		 	
												 ...
												 {	
													...
													if($item1->itemValue !="Custom")
														$controlString =  $control->GetSelectControl();	
		     										...
		     										{  
		     												if($item1 ->parameterName =="COMBINE" && $item1 ->optionName!= "")
		     												{
		     														...
		     														$controlString = $control->GetSelectControlForCombineCustom();
		     													    $controlString .="<div id='".$item1 ->optionName."'  name='Custom__".$item1 ->parameterName."'  width='100%'></div>";
		     													  													
		     												}
		     												else
		     												{
		     													$controlString = $control->GetSelectControlForCustom();
					...
					print	"<div style='height:".$lastTDHeight."px; margin-left:".$margin."px; margin-right:auto;' >
						  <table cellpadding='0' cellspacing='0' border='0'>
						    <tr>
