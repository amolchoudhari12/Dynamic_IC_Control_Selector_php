...
<head>
    ...
    <link href="Styles/CommonStyle.css" rel="stylesheet" type="text/css" />
     ...
     {
           parent.location='Model-Pricing.php?crid='+ id;
     }
...
<div id="dialog-message" title="Error">
 <div id="error_message">
	 ...
	 <form name="FormEnquiries" method="post"  >
                             ...
                             <table border="0" width="750"  id="userss" style="background: #000000; border-color: #666464">
                               ...
                               <tr>
					                <td class="ui-widget-header " >
					                    ...
					                    <span style="color:#ffffff;font-size:Larger;font-weight:bold;">     Enquiries:</span>
					                </td>
					            </tr>
					             <tr>
                                    <td >
                                     ...
                                     <table border="1" id="users-contain"  style="border-color: #666464;" class="ui-widget-content">
                                                    ...
                                                    <tbody>
                                 					...
                                 					<?php include 'SQLs/Select-Enquiries.php';
                                 					...
                                 					$a = new test("1");
                                 					 array_push($itemColl1,$a);
                                 					$b = new test("2");
                                 					 array_push($itemColl1,$b);
                                 					$c = new test ("3");
                                 					 array_push($itemColl1,$c);
                                 					
                                 					$_SESSION['aaa'] = $itemColl1;	
